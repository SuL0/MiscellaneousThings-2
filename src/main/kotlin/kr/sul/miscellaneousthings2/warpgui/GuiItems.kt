...
object GuiItems {
    ...
    val hardButton: ItemStack
        get() = ItemStack(Material.SKULL_ITEM, 1, 2).warpName("하드")
    ...
    val hellButton: ItemStack
        get() = ItemStack(Material.SKULL_ITEM, 1, 1).warpName("지옥")
    ...
    val silenceButton: ItemStack
        get() = ItemStack(Material.JACK_O_LANTERN).warpName("사일런스")
    ...
    val lockedButton: ItemStack
        get() = ItemStack(Material.RECORD_5).warpName("잠김")
            .nameIB("§7§l:: LOCKED ::")
    ...
    private fun ItemStack.warpName(name: String): ItemStack {
        ...
        nbti.tag.setString(WARP_NAME_KEY, name)
    ...
    fun ItemStack.channel(channel: Int): ItemStack {
        ...
        val nbti = NbtItem(this)
        nbti.tag.setInt(CHANNEL_KEY, channel)
        nbti.applyToOriginal()
        return this
    }
